 ...
 * @author Quichiz
 */
@WebServlet(name = "ReporteMedicoServlet", urlPatterns = {"/ReporteMedicoServlet"})
public class ReporteMedicoServlet extends HttpServlet {

     protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            // Ruta del archivo .jasper compilado
            String pathJasper = getServletContext().getRealPath("/reportes/reportMedicos.jasper");
